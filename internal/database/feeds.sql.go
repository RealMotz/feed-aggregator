...
SELECT id, created_at, updated_at, name, url, user_id, last_fetch_at FROM feeds ORDER BY last_fetch_at NULLS FIRST LIMIT $1
`
...
WHERE id = $1 RETURNING id, created_at, updated_at, name, url, user_id, last_fetch_at
`
